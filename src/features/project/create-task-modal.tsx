    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Create New Task">
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left">
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="task-description" className="text-xs font-medium text-zinc-500">
            Description
          </label>
          <textarea
            id="task-description"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="task-priority" className="text-xs font-medium text-zinc-500">
              Priority
            </label>
            <select
              id="task-priority"
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="task-assignee" className="text-xs font-medium text-zinc-500">
              Assignee
            </label>
            <select
              id="task-assignee"
